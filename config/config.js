module.exports = {
    ...
    request: {
        ...
        // Relative paths are relative to the Cybersponse integration's root directory
        cert: '',
         ...
         * to Cybersponse servers without valid SSL certificates.  Please note that we do NOT recommending setting this
    ...
    options: [
        {
            key: "host",
            name: "Host",
            description: "Your CyberSponse host.",
            default: "",
            type: "text",
            userCanEdit: false,
            adminOnly: true
